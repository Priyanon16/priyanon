...
<form method="post" action="">
    ...
    <div class="d-grid gap-2 mt-4">
        <button type="submit" name="Submit" class="btn btn-success">ส่งใบสมัคร</button>
  ...
  <?php
    if (isset ($_POST['Submit'])) {
	   ...
	   $sql = "INSERT INTO application (a_id, a_job, a_title, a_fullname, a_edu, a_skill, a_exp, a_phone, a_email) VALUES (NULL, '{$job}', '{$title}', '{$fullname}', '{$edu}', '{$skill}', '{$exp}', '{$phone}', '{$email}');";
